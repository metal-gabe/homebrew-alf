class Alf < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/metal-gabe/alf/releases/download/v#{version}/alf-v#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "1d70857cd07caf571952af4c2b309ee5a9d8e86de226ec300d72652e534b4c39"
    end

    on_intel do
      url "https://github.com/metal-gabe/alf/releases/download/v#{version}/alf-v#{version}-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/metalgabe/alf/releases/download/v#{version}/alf-v#{version}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "9cfec0607138b25f848b7598dccaa68c593603fcb8ae2d740ccfd232ee85a451"
    end

    on_intel do
      url "https://github.com/metalgabe/alf/releases/download/v#{version}/alf-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
